                                ...
                                <form>
                                    ...
                                    <div class="input-group input-group-lg input-group-round mb-2">
                                        <div class="d-flex w-100 justify-content-between">
                                            <label class="px-3 mb-0">Please enter the 6 digit code you received by email on <?php echo $row['email']; ?> here:</label>
                                    ...
                                    <div class="input-group input-group-lg input-group-round mb-2">
                                        <div class="d-flex w-100 justify-content-between">
                                            <label class="px-3 mb-0">Please enter the 4 digit code you received by SMS on <?php echo $row['mobile']; ?></label>
                                    ...
                                    <!--<div class="px-3">-->
                                        ...
                                        <?php } ?>
                                    <!--</div>-->
                                    <button type="button" id="checkout" class="btn btn-lg btn-round btn-indigo btn-block mb-0 text-capitalize checkout" <?php if((!isset($everify)) OR (!isset($mverify)) OR (!isset($eaverify)) OR (!isset($maverify)) ){ ?>disabled="disabled" <?php } ?> ><i class="fas fa-sign-in-alt"></i>Continue</button>
