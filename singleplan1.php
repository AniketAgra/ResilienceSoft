...
/* .country-show:hover{
    background-color: skyblue;
        ...
        figure p{ font-size:12px;font-weight:600;margin-left:38px;overflow-wrap: break-word; }
        .text-block {
        position: absolute;
        bottom: 0;
...
span.display-activa8, .display-activa8 {
    font-size: 20px;
}
.plan-city-img {
    margin-left: 20px;
...
tr.t_head th, tr.t_head td {
    background-color: transparent;
}
tr.total_charge th, tr.total_charge td{
    font-family: 'Arial';
    background-color:transparent;
}
tr.total_charge {
...
td.font-weight-500.pr-3.text-right.esimamt22.display-activa22, span.display-activa22 {
    display: none;
}
.pl_op {
...
<?php
    ...
    ?>
    <div class="container">
    <div class="modal fade show box_sec" id="modalZones1" tabindex="-1" role="dialog" aria-modal="true" style="display: block; position:unset;">
                ...
                <div class="modal-body p-0">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb gsm-breadcrumb">
                            <li class="breadcrumb-item"><a href="https://dev.mysimaccess.com/index5"><i class="fa-solid fa-house"></i></a></li>
                            <li class="breadcrumb-item"><a href="https://dev.mysimaccess.com/#eSim">Plans</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><a href="singleplan?tags=<?php echo $row['tags']; ?>"><?php echo $row['zone_name']; ?></a></li>
                        </ol>
                    </nav>
                    ...
                    <div class="row no-gutters">
                        <div class="col-lg-12 col-xl-4 country-img1">
                            <div class="col-12">
                                <h5 class="font-weight-700 text-center pb-2 mb-2 plans-title"><?php echo $row['zone_name']; ?></h5>
                            </div>
                                                    ...
                                                    <div class="tab-content " id="myTabContent">
                                                        <div class="tab-pane fade show active" id="country-tab" role="tabpanel" aria-labelledby="country-tab"> 
                                                            <div class="row">
                                                                ...
                                                                ?>
                                                                <div class="col-6 col-md-3 col-lg-4 col-xl-4 countfl" style="margin:5px -20px">
                     ...
                     <!-- main content right side -->
                        <div class="col-lg-12 col-xl-8">
                            <div class="px-4 px-md-3 px-lg-3 px-xl-3 px-xl-3 pt-5 nospace">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <p style="font-family: 'Arial'; font-weight: 700;">Select Your <span style="color:#003dbd">gsm</span><span style="color:#64ae02">2go</span> esim Package</p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    ?>
                                        <div class="col-md-4 col-lg-3 col-xl-4 p-0 pl_op">
                                            <table class="table table-borderless bg_plan" style="margin-bottom:0rem !important;">
                                                <thead>
                                                    <tr>
                                                        <td class="font-weight-500 line-height pt-0" colspan="2">
                                                            <div class="img_pklan d-flex" style="padding-top: 15px;">
                                                                <ul class="m-0 plan-charge-item p-0">
                                                                    <?php if(!empty($plan_row['Days'])){ ?>
                                                                        <li><i class="fa-solid fa-calendar-days"></i><?php echo $plan_row['Days']; ?> Days</li>
                                                                    <?php } if(!empty($plan_row['GB'])){ ?>
                                                                        <li><i class="fa-solid fa-database"></i><?php echo $plan_row['GB']; ?> GB Data</li>
                                                                    <?php } ?>
                                                                </ul>
                                                                <div class="plan_img" style="width:50%; text-align: end;"><img src="assets/images/banner/tourimag.jpeg" alt="show_img" style="width:50%"></div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <input type="hidden" class="usd<?php echo $plan_row['id']; ?>" value="<?php echo $plan_row['USD']; ?>">
                                                        ...
                                                        ?>
                                                        <?php } } ?>
                                                        <tr class="total_charge" style="background: #64ae02;">
                                                            <?php
                                                                if($i == 1)
                                                                {
                                                            ...
                                                            ?>    
                                                            <th class="pr-3 t_plan"><i class="fa-solid fa-dollar-sign"></i><?php echo $plan_row['USD']+$esimamt+$actamt; ?></th>
                                                                <td class="font-weight-800 text-right text-dark"><input type="radio" class="total total<?php echo $plan_row['id']; ?>" name="charge" id="<?php echo $plan_row['id']; ?>" value="<?php echo $plan_row['id']; ?>" onclick="get_plan_price('<?php echo $plan_row['USD']; ?>')" readonly <?php if($i==1){echo "checked";} ?> >
                                                            </td>
                                                        </tr>
                                                </tbody>
                                            </table>
                                ...
                                <div class="row mars" style="margin: 20px 0;">
                                    <div class="col-12">
                                        <p style="font-family: Arial; font-weight: 500; margin:0">Recommended Add Ons</p>
                                    </div>
                                </div>
                                ...
                                <div class="row loioi">
                                    <div class="col-md-4 col-lg-3 col-xl-4 p-0 pl_op">
                                        <div class="exd">
                                            <div class="olan_ek">
                                                ...
                                                <div class="content_pl" style="font-size: 12px;">
                                                    We keep your eSIM live for your next trip<br>(no need to reactive in the future) for<br>$1/month.<br>
                                                ...
                                                <div>
                                                <label><span style="font-size:20px;" class="text-center">$1/Month</span>
                                                    <input type="checkbox" class="cheee" id="esimlive<?php //echo $cid;?>" name="esim_live" value="<?php echo $live;?>"  <?php echo $chk;?>>
                                                </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 col-lg-3 col-xl-4 p-0 pl_op">
                                        <div class="exd">
                                            <div class="olan_ek">
                                                ...
                                                <div class="content_pl" style="font-size: 12px;">
                                                    Never run out of data.<br>When you data allocation reaches its limit<br>We will automatically apply a new package<br>
                                                   for you.<br><br>
                                                </div>
                                                <div>
                                                <label><span style="font-size:20px;" class="text-center">Opt for auto Renewal</span>
                                                <?php
                                                                ...
                                                                ?>
                                                                <input type="checkbox" id="autorenewal_data" class="cheee" name="autorenewal" <?php echo $test_check;  ?>>
                                                                </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 col-lg-3 col-xl-4 p-0 pl_op">
                                        <div class="exd">
                                            <div class="olan_ek">
                                                <div class="titlke_li">
                                                    <p class="text-center">Talk Time Options</p>
                                                </div>
                                                <div class="content_pl" style="font-size: 12px;">
                                                ...
                                                <div>
                                                <label><span style="font-size:20px;" class="text-center">$8</span>
                                                    <input type="checkbox" class="cheee" id="talktime" name="esim_live" value="<?php echo $live;?>"  <?php echo $chk;?>>
                                                </label>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-12 box_bt_cart">
                            <div class="row">
                                    <div class="col-12 col-md-12 col-lg-8 ms-auto green-btn">
                                    <div class="row justify-content-between planss">
                                        <div class="planspace col-lg-3">
                                            <div class="d-flex mt-4  mb-4 mkr">
                                            <div>
                                                <button class="btnmp btn px-2" onclick="func_minus(); return false;" ><i class="fas fa-minus"></i></button>
                                                <input type="text" name="qty" class="myinput2 num_mp" id="quantity_220" value="1" size="2" readonly="">
                                                <input type="hidden" name="cid" id="cid" value="220">
                                                <button id="btn_220" class="btnmp btn btn-link px-2" onclick="func_plus(); return false;"><i class="fa fa-plus"></i></button>
                                            </div>
                                            <input type="hidden" id="plan_price" value="<?php echo $basic_plan; ?>">
                                            <h5 style="margin:5px 0px 0px 5px; font-family: arial;" >$<input type="text" name="cost" class="myinput pmpr" id="cost_220" value="<?php echo $basic_plan; ?>" size="4" readonly="" fdprocessedid="na5b5i"></h5>
                                        ...
                                        <div class="col-5 col-lg-3">
                                            ...
                                            <?php 
                                                ...
                                                if(mysqli_num_rows($cart_details) > 0) { ?>
                                                    <button type="button" onclick="window.location='cart2'; return false;" id="addtocart_<?php echo $plan_row['id']; ?>" style="font-size:15px;" class="btn btn-block btn-round btn-md btn-success mt-4 mb-4 buy-now<?php echo $plan_row['id']; ?>" disabled>Added to cart</button>
                                                <?php } else { ?>
                                                    <button type="button" onclick="add2cart('<?php echo $plan_row['id']; ?>');" id="addtocart_<?php echo $plan_row['id']; ?>" style="font-size:15px;" class="btn btn-block btn-round btn-md btn-success mt-4 mb-4 buy-now<?php echo $plan_row['id']; ?>" disabled>Add to cart</button>
                                                <?php } ?>
                                        </div>
                                        <div class="col-5 col-lg-3">
                                            <?php if(isset($_SESSION['user'],$_SESSION['role']) && $_SESSION['role']=="U"){ ?>
                                            <button type="submit" formaction="<?php echo constant("SITEURL"); ?>checkout" id="<?php echo $plan_row['id']; ?>" style="font-size:15px;" class="btn btn-block btn-round btn-md btn-primary mt-4 mb-4 buy-now<?php echo $plan_row['id']; ?>" disabled>Proceed to Buy</button>
                                            <?php } else{ ?>
                                            <button type="submit" formaction="<?php echo constant("SITEURL"); ?>signup" id="<?php echo $plan_row['id']; ?>" style="font-size:15px;" class="btn btn-block btn-round btn-md btn-primary mt-4 mb-4 buy-now<?php echo $plan_row['id']; ?>" disabled>Proceed to Buy</button>
                                            <?php } ?>
                                        </div>
                                        </div>
    ...
    <div class="container should-know">
                              <div class="row">
                                <div class="col">
                                    <div class="ti_wh">
                                <h3> What’s Unique About the <font color="blue">gsm</font><font color="green"><i>2go</i></font> eSIM</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class=" block_what_should">
                                        ...
                                        *With the Talk Time add-on option:
                                        You can keep your <font color="blue">gsm</font><font color="green"><i>2go</i></font> eSIM after your travel and make international calls and receive calls on your UK/USA/other phone number.</div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class=" block_what_should">
                                        ...
                                        But once you <a href="#" style="color: #212529; text-decoration: underline !important;"> activate </a> it on your phone and <a href="#" style="color: #212529; text-decoration: underline !important;"> register on a network,</a>  your plan’s allocated duration begins.
                                                          </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
   ...
   readrecords();
    ...
    function add2cart(planId) {
        ...
        $.ajax({
            ...
            type: "POST",
            data: { planId:planId , autorenewal:autorenewal,esimLive:esimLive,qty:qty,talktime:talktime },
