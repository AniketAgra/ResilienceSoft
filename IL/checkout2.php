                        ...
                        <div class="bg-white rounded-xl shadow-lg pt-4 pb-2" style="min-height:625px;">
                            ...
                            <?php
                                ...
                                <div class="d-lg-block">
                                    <h5 class="font-weight-700 mb-0 text-right px-4 px-md-5 px-lg-4 px-xl-4"><?php echo $zone; ?> - <?php echo $plan_name; ?></h5>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="pb-3">
                        <div class="bg-white rounded-xl shadow-lg px-4 py-5 p-md-4">
                            <h5 class="font-weight-700 section-title-4 text-right pb-2 mb-2 bg-img">
                                Payment Details
                                <div class="title-divider-round mt-3"></div>
                            </h5>
                            <h5 class="font-weight-700 section-title-4 text-right pb-2 mb-2 bg-img1 d-none">
                                <?php echo $row['plan_name']; ?>
                                <div class="title-divider-round mt-3"></div>
                            </h5>
                            <div class="payment_section">
                                <form name="payment_form">
                                    <div class="border mb-3">
                                        <input type="radio" id="html" name="payment_method" value="card">
                                        <label for="html">Debit/Creadit Card</label><br>
                                    </div>
                                    <div class="border mb-3">
                                    ...
                                    <div class="border mb-5">
                                        <input type="radio" id="javascript" name="payment_method"   value="Other Option">
                                        <label for="javascript">Option 3</label>
                                    </div>
                                    
                                    <button id="payment_button" class="btn btn-primary">Process Payment</button>
                                </form> 
                            </div>
