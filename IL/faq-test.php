...
<div class="d-flex flex-column w-100">
    <div class="page-title d-flex align-items-center bg-image" data-img-src="assets/images/faq-banner.jpg">
...
<div class="main-content py-0">
    ...
    <div class="section bg-image py-5 mobile-none" data-img-src="assets/images/upload/faq.jpg">
        <div class="container">
            <div class="row my-5">
                <div class="col-lg-8 offset-lg-2">
                    <div class="text-center my-4">

                        <h2 class="display-5 font-weight-400 text-white mb-2">Didn't find an answer?</h2>
                        <div data-height="10px"></div>
                        <form method="post" action="contact-us" target="_blank">
                            <input type="hidden" name="value" value="FAQ">
                            <button type="submit" name="submit" class="btn btn-lg btn-round btn-outline-light mb-0">
                            <i class="fas fa-paper-plane"></i>Contact Us</button>
                        </form>
                    </div>
                </div>
            </div>
