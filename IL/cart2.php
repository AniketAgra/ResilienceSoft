...
@media(max-width: 575px){
 ...
 .r_r .btn,.r_r .btn:hover, .r_r .btn:focus {
...
<section class="h-100" style="background-color: #eee;">
 ...
 <div class="card rounded-3 mb-4" id="recordid_<?php echo $cid; ?>">
          <div class="card-body p-6">
            <div class="row d-flex justify-content-between align-items-center heading-rtl">
        <div class="col-6 col-md-6 col-lg-4 col-xl-3">
          <h3 class="fw-normal mb-0 text-black">Shopping Cart</h3>
          
        </div>
         <div class="col-6 col-md-6 col-lg-4 col-xl-3 mt-sm-3"  id="grand_total_top">
...
//echo "Num rows : $numrows";
    ...
    $zone=$res['zone_name'];
        ?>
         <div class="card rounded-3 mb-4" id="recordid_<?php echo $cid; ?>">
          <div class="card-body p-6">
            <div class="row d-flex  align-items-center card-item-rtl">
              ...
              <input type="hidden" name="cid" id="cid" value="<?php echo $cid;?>">
                ...
                <h5>$<input type="text" name="cost" class="myinput" id="cost_<?php echo $cid; ?>"  value="<?php echo $cost;?>" size="4" readonly></h5>
              </div>
    ...
    <br>
          ...
          <div class="card-body p-4">
            <div class="row d-flex justify-content-between align-items-center total-rtl">
              
            <div class="col-2 col-md-2 col-lg-3 col-xl-2 d-flex hide-class">
                <h5>&nbsp;</h5>
              </div>
              <div class="col-10 col-md-5 col-lg-4 col-xl-4 " style="margin-right:30px; font-family:'Arial';" >
  ...
  <div class="col-4">
        ...
        <div class="card rounded-3 mb-4" id="cart_buttons">
          <div class="card-body p-6"> 
            <div class="row d-flex justify-content-between align-items-center total-btn-rtl">
              <div class="col-md-12 col-lg-4 col-xl-3">
                  <a href="https://gsm2go.com/" ><button class="button blue">Continue</button></a>
              </div>
              <div class="col-md-12 col-lg-4 col-xl-3">
