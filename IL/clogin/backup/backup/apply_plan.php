...
if ($SERVICE && $METHOD) {
    ...
    $params = array('account_info' => array("i_account" => 44859300, "firstname" => "Test", "lastname" => "Demo", "email" => "abc@abc.com", "subscriber_email" => "abc@abc.com", "assigned_addons" => [array("i_product" => 34139), array("i_product" => 34137)]));
