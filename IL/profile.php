...
a.btn.btn-lg.btn-round.btn-outline-light.mb-0 i{
    margin-left: 10px;
}
...
<div class="d-flex flex-column w-100">
    <div class="page-title d-flex align-items-center bg-image py-5" data-img-src="assets/images/upload/page-title-bg-25.jpg">
        <div class="container page-title-container">
            ...
            <div class="row align-items-center py-5 profile-rtl">
                ...
                <div class="col-lg-3">
                    <div class="pb-3 mb-3">
                        <div class="bg-white rounded-xl shadow-sm py-5">
                            ...
                            <div class="px-4 px-md-5 px-lg-4 px-xl-5 user-rtl">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="pb-3 mb-3">
                        <div class="bg-white rounded-xl shadow-sm px-4 py-5 p-md-5">
                            ...
                            <h5 class="font-weight-700 section-title-4 text-left pb-2 mb-4 heading-rtl">
                                Personal Information
