...
.footer-bottom-container .row .col-lg-6{
    display: flex;
    align-items: center;
...
<div class="bg-viridian-500 text-white-50">
    ...
    <!--                <div class="widget">-->
    <!--                    <img class="img-fluid d-block mb-4" src="assets/logo.png" alt="logo" data-width="146px" data-height="42px">-->
    <!--                    <div data-height="5px"></div>-->
                        <!--<p>Pulvinar mauris metus sed nibh iaculis nec congue lacus ultrices ac vestibulum consequat sapien quis interdum.</p>-->
    <!--                </div>-->
    <!--                <div class="widget">-->
    <!--                    <h6 class="widget-title text-white text-uppercase font-weight-700 mb-4">Follow Us</h6>-->
    <!--                    <div class="d-flex ml-n2">-->
    <!--                        <a href="#" target="_blank" class="d-flex align-items-center justify-content-center text-white-25 text-hover-primary" data-width="36px" data-height="36px"><i class="fab fa-facebook-f"></i></a>-->
    <!--                        <a href="#" target="_blank" class="d-flex align-items-center justify-content-center text-white-25 text-hover-primary" data-width="36px" data-height="36px"><i class="fab fa-twitter"></i></a>-->
    <!--                        <a href="#" target="_blank" class="d-flex align-items-center justify-content-center text-white-25 text-hover-primary" data-width="36px" data-height="36px"><i class="fab fa-linkedin-in"></i></a>-->
    <!--                        <a href="#" target="_blank" class="d-flex align-items-center justify-content-center text-white-25 text-hover-primary" data-width="36px" data-height="36px"><i class="fab fa-instagram"></i></a>-->
    <!--                        <a href="#" target="_blank" class="d-flex align-items-center justify-content-center text-white-25 text-hover-primary" data-width="36px" data-height="36px"><i class="fab fa-vimeo-v"></i></a>-->
    <!--                    </div>-->
    <!--                </div>-->
    <!--            </div>-->
    ...
    <!--                            310 Mountain View Ave, San Rafael, CA 94901, USA-->
    <!--                        </li>-->
    <!--                        <li class="mb-3">-->
    ...
    <div class="footer-bottom py-2 fixed-footer bg-dark">
        <div class="container footer-bottom-container">
            <div class="row py-1">
                <div class="col-lg-6  text-lg-left mb-2 mb-lg-0">
                    
                    <small style="font-family: Calibri, sans-serif;
        font-size:11pt;">Copyright @ gsm2go. All Rights Reserved.</small>
                </div>
                <div class="col-lg-6  text-lg-right">
					 <a href="cellular-data-optimziation-guide.php" class="text-white-50 text-hover-primary mx-2" style="font-family: Calibri, sans-serif;
        font-size:11pt;">שימוש נכון בנתונים סלולריים</a>&nbsp;|&nbsp;
					  
                     <a href="contact-us.php" class="text-white-50 text-hover-primary ml-2" style="font-family: Calibri, sans-serif;
        font-size:11pt;">צור קשר</a>&nbsp;|&nbsp;
                  
                    <a href="gdpr.php" class="text-white-50 text-hover-primary mr-2" style="font-family: Calibri, sans-serif;
        font-size:11pt;">GDPR</a> &nbsp;|&nbsp; 
                   <a href="tnc.php" class="text-white-50 text-hover-primary mr-2" style="font-family: Calibri, sans-serif;
        font-size:11pt;">האותיות הקטנות </a>
