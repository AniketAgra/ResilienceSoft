...
<?php
                    ...
                    <div class="row no-gutters">
                                                    ...
                                                    <div class="tab-content " id="myTabContent">
                                                        <div class="tab-pane fade show active" id="country-tab" role="tabpanel" aria-labelledby="country-tab"> 
                                                            <div class="row">
                                                                ...
                                                                ?>
                                                                <div class="col-6 col-md-4 col-lg-3 col-xl-3 countfl">
                     ...
                     <!-- main content right side -->
                            ...
                            <div class="px-4 px-md-3 px-lg-3 px-xl-3 px-xl-3 pt-5 nospace">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <!-- <div class="col-12 col-md-12 mb-3 pl-0">
                                                    <span class="font-weight-600 plan-include-title">This plan includes the following </span>
                                                    <span class="font-weight-600 text-success">  Countries:</span>
                                                </div>
                                        </button> -->
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <p style="font-family: 'Arial'; font-weight: 700;" class="plans_rtl">Select Your <span style="color:#003dbd">gsm</span><span style="color:#64ae02">2go</span> esim Package</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 box_bt_cart">
                            <div class="row">
                                    <div class="col-12 col-md-12 col-lg-8 me-auto green-btn">
    ...
    <div class="container">
                            ...
                            <div class="row know-rtl">
                                <div class="col-lg-4">
                                    <div class=" block_what_should">
                                        <div class="ic_what_should text-right">
                                        <i class="fa-regular fa-phone-slash"></i>
                                        </div>
                                        <div class="title_what_should text-right">
                                        No local phone number
                                        </div><br>
                                        <div class="sub_tex_what_should text-right">
                                        This eSIM only includes data. It does not allow you to make cell phone calls or send SMS messages. You can still use WhatsApp or Skype to call your contacts.
                                        </div>
                                    </div>
                                </div>
