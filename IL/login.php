...
if(isset($_SESSION['purType']) && $_SESSION['purType'] == 'Recharge') {
...
else if(isset($_SESSION['user'],$_SESSION['role'],$_SESSION['a2k_checkout']) && $_SESSION['a2k_checkout'] == 'a2k') {
                        ...
                        <div class="px-xl-4">
                            <div class="bg-white rounded-ultra shadow-lg px-4 py-5 py-md-3 my-5">
                                ...
                                <div id="error-msg" class="text-center col-md-12"><?php if(isset($_SESSION['userid']) && !empty($_SESSION['userid'])){ echo '<div class="text-success mb-0 mx-2">Password Sent Your Email Address</div>'; } ?></div>
                                    <div class="input-group input-group-lg input-group-round mb-0 input-rtl">
                                        <div class="input-group-inner">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text input-group-icon"><i class="far fa-envelope"></i></span>
                                            </div>
                                            <input type="text" class="form-control form-control-lg" id="username" placeholder="Username" <?php if($loginEmail != '') { echo "readonly"; } ?> value="<?php if(isset($_SESSION['q'])) { echo $_SESSION['q']; } else if($loginEmail != '') { echo $loginEmail; } ?>" tabindex="1" autocomplete="off">
                                            <div class="input-focus-bg"></div>
                                        </div>
                                        <span class="err1 w-100 text-white font-weight-500 h-25" style="font-size:12px;"></span>
                                    </div>
                                    <div class="input-group input-group-lg input-group-round mb-2 input-rtl">
                                        <div class="input-group-inner">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text input-group-icon" id="eye"><i class="far fa-eye-slash"></i></span>
                                            </div>
                                            <input type="password" id="password" class="form-control form-control-lg" placeholder="Password" tabindex="2" autocomplete="off">
                                            <div class="input-focus-bg"></div>
                                        </div>
                                    ...
                                    <div class="w-100 pt-1 text-center" style="height:25px">
                                        <form method="post" action="forgot-password">
                                            ...
                                            <button type="submit" name="submit" style="display:initial;" id="forgot-password">Forgot password?</button>
                                        </form>
                                    </div>
