...
?>
          ...
          <div class="card-body p-6">
            <div class="row d-flex justify-content-between align-items-center">
              ...
              <div class="col-md-3 col-lg-3 col-xl-3">
                ...
                <p>
                    <label class="container">eSIM Live
          ...
          <div class="card-body p-4">
            ...
            <div class="col-md-2 col-lg-3 col-xl-2 d-flex">
              ...
              <div class="col-md-5 col-lg-4 col-xl-4 " style="margin-right:30px;">
                 <h5>TOTAL  $<input type="text" name="total" class="myinput" id="total"  value="<?php echo $total;?>" size="4" readonly>   </h5>
              </div>
              </div>
            </div>
          </div>
  ...
  <div class="col-4">
    ...
    <div class="card mb-4">
          <div class="card-body p-4 d-flex flex-row flex-wrap cart-btn">
                <div class="col-md-6"><button type="button" class="btn btn-lg btn-round btn-indigo btn-block mb-0 py-4"  style="line-height:0">Continue</button>
               </div>
            <div class="col-md-6">
            <button type="button" class="btn btn-lg btn-round btn-success btn-block mb-0 py-4"  style="line-height:0">Checkout</button>
           </div>
          </div>
        </div>
