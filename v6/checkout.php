...
function getAnAcceptPaymentPage()
{
    ...
    $setting5->setSettingValue(
        "{\"url\": \"https://qr2.gsm2go.com/v6/checkout.php?auth=true\",}"
    );
                                    ...
                                    <div class="col-12">
                                        ...
                                        if(isset($_GET['retrypayment'])){
                                            ...
                                            if(isset($total_charge) && !isset($_GET['auth'])) {
                                                $sql = "INSERT INTO orders (userId,email,plan_id,GB,Mins,SMS,Days,esimLive,USD,status,orderType,date )
                VALUES ('".$_SESSION['userId']."','".$_SESSION['user']."','".$_SESSION['direct']."','".$row['GB']."','".$row['Mins']."','".$row['SMS']."','".$row['Days']."','".$esimLiveValue."','$total_charge','PENDING PAYMENT','".$_SESSION['purType']."','".date('Y-m-d H:i:s')."')";
