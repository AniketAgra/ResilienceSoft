...
else
{
	...
	if(mysqli_num_rows($check)===0)
	{
		...
		if($insert)
		{
			...
			$url = "https://qr2.gsm2go.com/v6/verification?userId=".$userId.'&ecode='.$emailcode;
			$url1 = "https://qr2.gsm2go.com/v6/verification";
				                    ...
				                    <tbody>
				                                ...
				                                <table cellspacing="0" cellpadding="0">
				                                    <tbody>
				                                        <tr>
				                                            ...
				                                            <td width="250" valign="top" align="right"><div style="margin: 0px; font-size: 20px; font-family: arial, sans-serif;"></div></td>
				                                        </tr>
				                                    </tbody>
				                                </table>
				                            </td>
				                        ...
				                        <tr>
				                            <td style="padding-left: 0px; padding-top: 9px; padding-bottom: 9px;">
				                                <div style="margin: 0px; font-size: 18px; font-family: arial, sans-serif;">Dear '.$fname.' '.$lname.',</div>
				                                <div style="margin: 0px; font-size: 18px; font-family: arial, sans-serif;">Per your request, here is your gsm2go eSIM verification code (one time password): </div>
				                                <div style="margin: 0px; font-size: 22px; font-family: arial, sans-serif; padding-top: 18px;">'.$emailcode.'</div>
				                                ...
				                                <div style="margin: 0px; font-size: 20px; font-family: arial, sans-serif;">Thank you from <span style="color:rgb(0,112,192)">gsm</span><i><span style="color:rgb(0,176,80)">2go</span></i></div>
				                            </td>
				                        </tr>
				                    </tbody>
				                </table>
