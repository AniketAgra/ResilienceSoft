...
<div class="main-content py-0">
    <div class="section">
        <?php include("includes/recharge-plans.php"); ?>
    </div>
</div>
...
//       history.replaceState ("object or string", "Title of the page", "/v6/"+url);
//     } else {
...
// function CloseUrl() {
//     if (history.pushState) {
//       history.replaceState ("object or string", "Title of the page", "/v6/");
//     } else {
//       document.location.href = "/v6/";
//     }
// }
</script>
<?php if(isset($_GET['utmtype'])){ ?>
<script>
 $(document).ready(function(){
    $('#modalZones<?php echo $_GET['utmtype']; ?>').modal('show');
 });
</script>
<?php } ?>
</body>
