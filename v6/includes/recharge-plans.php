                                                ...
                                                <div class="row">
                                                    <form method="post">
                                                        ...
                                                        <div class="col-12 col-md-6 mx-auto">
                                                            ...
                                                            <input type="hidden" name="purType" value="Recharge">
                                                            <input type="hidden" name="esim" value="">
                                                            <input type="hidden" name="recCustomerId" value="<?php echo $_GET['utmsource']; ?>">
                                                            ...
                                                            <?php } else{ ?>
                                                            <button type="submit" formaction="https://qr2.gsm2go.com/v6/login" id="<?php echo $plan_row['id']; ?>" class="btn btn-block buybutton btn-round btn-md btn-primary mx-2 mt-4 mx-lg-3 mb-4 buy-now<?php echo $plan_row['id']; ?>" disabled>Proceed</button>
                                                            <?php } ?>
                                                        </div>
                                                    </form>
                                                </div>
