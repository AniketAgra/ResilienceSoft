                                                ...
                                                <div class="row">
                                                    <form method="post">
                                                        ...
                                                        <div class="col-12 pl-4">
                                                            ...
                                                            <div class="form-check mb-2">
                                                                ...
                                                                <label class="form-check-label">
                                                                    I understand that in order to use an eSIM, I need an eSIM compatible phone (please see <a href="https://qr2.gsm2go.com/v6/esim-phones" target="blank">list</a> here).
                                                                </label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input agree agree<?php echo $plan_row['id']; ?>" type="checkbox" value="<?php echo $plan_row['id']; ?>">
                                                                <label class="form-check-label">
                                                                    I am ok with the <font color="blue">gsm</font><font color="green">2go</font> eSIM <a href="https://qr2.gsm2go.com/v6/tnc" target="blank">Term and Conditions and Privacy Policy</a>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-md-6 mx-auto">
                                                            ...
                                                            <button type="submit" formaction="https://qr2.gsm2go.com/v6/checkout" id="<?php echo $plan_row['id']; ?>" class="btn btn-block buybutton btn-round btn-md btn-primary mx-2 mt-4 mx-lg-3 mb-4 buy-now<?php echo $plan_row['id']; ?>" disabled>Proceed</button>
                                                            <?php } else{ ?>
                                                            <button type="submit" formaction="https://qr2.gsm2go.com/v6/signup" id="<?php echo $plan_row['id']; ?>" class="btn btn-block buybutton btn-round btn-md btn-primary mx-2 mt-4 mx-lg-3 mb-4 buy-now<?php echo $plan_row['id']; ?>" disabled>Proceed</button>
                                                            <?php } ?>
                                                        </div>
                                                    </form>
                                                </div>
