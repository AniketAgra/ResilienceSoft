                        ...
                        <div class="px-xl-4">
                            <div class="bg-white rounded-ultra shadow-lg px-4 py-5 py-md-4 my-3">
                                ...
                                <form>
                                    ...
                                    <button type="button" id="register" class="btn btn-lg btn-round btn-indigo btn-block mb-0 py-4" style="line-height:0">Create my account</button>
                                </form>
