...
<head>
    ...
    <title>gsm2go | Order Detail</title>
...
if(isset($_GET['orderId']) && $_GET['orderId'] != "") 
{
    ...
    <table style="width: 100%;" border="0">
        ...
        <tbody>
            <tr>
                <td style="padding: 0px 10px;margin: 0;color: #4c4c4c;font-weight: 400;font-size: 13px;line-height: 1.5;">
                    Thank you for purchasing a gsm2go eSIM. Below you will find QR code and a brief installation guide
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="padding: 0px 10px; border:1px solid; margin: 0;color: #4c4c4c;font-weight: 400;font-size: 13px;line-height: 1.5;">
            ...
            <tr>
                <td style="padding: 25px 10px;margin: 0;color: #4c4c4c;font-weight: 400;font-size: 13px;line-height: 1.5;">
