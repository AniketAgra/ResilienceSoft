...
<head>
    ...
    <link rel="icon" href="https://qr2.gsm2go.com/v5/assets/favicon.ico">
    <title>gsm2go | Plans </title>
    <!-- Font Awesome CSS -->
    <link rel="stylesheet" href="https://qr2.gsm2go.com/v5/node_modules/%40fortawesome/fontawesome-free/css/all.min.css">
    <!-- Animate CSS -->
    <link rel="stylesheet" href="https://qr2.gsm2go.com/v5/node_modules/animate.css/animate.min.css">
    <!-- Fancybox CSS -->
    <link rel="stylesheet" href="https://qr2.gsm2go.com/v5/node_modules/%40fancyapps/fancybox/dist/jquery.fancybox.min.css">    
    <!-- OWL carousel CSS -->
    <link rel="stylesheet" href="https://qr2.gsm2go.com/v5/node_modules/owl.carousel/dist/assets/owl.carousel.min.css">
    <link rel="stylesheet" href="https://qr2.gsm2go.com/v5/node_modules/owl.carousel/dist/assets/owl.theme.default.min.css">
    <!-- Main CSS -->
    <link rel="stylesheet" href="https://qr2.gsm2go.com/v5/assets/css/style.min.css">
    <!-- Google Font -->
    ...
    <div class="container-fluid px-5">
        <div class="navik-header-container">
            ...
            <div class="logo" data-mobile-logo="assets/logo.png" data-sticky-logo="assets/logo.png">
                <a href="/v6"><img src="https://qr2.gsm2go.com/v6/assets/logo.png" alt="logo"/></a>
            </div>
            ...
            <nav class="navik-menu menu-caret menu-hover-3 submenu-top-border submenu-scale">
                <ul>
                    <li class="current-menu"><a href="/v6/index#eSim">eSim</a></li>
                    <li><a href="https://qr2.gsm2go.com/v6/global-dialer-plans">Global Dialer</a></li>
                    <li><a href="https://qr2.gsm2go.com/v6/virtual-numbers.php">Virtual Numbers</a></li>
                    <li><a href="https://qr2.gsm2go.com/v6/faq">FAQ</a></li>
                    <li><a href="https://qr2.gsm2go.com/v6/about-us">About Us</a></li>
                    <li>
                        <?php if(isset($_SESSION['user']) && ($_SESSION['role']=="U") ){?>
                        <a href="#"><?php echo $_SESSION['fname']; ?></a>
                        <ul class="submenu">
                            <li><a href="https://qr2.gsm2go.com/v6/orders"><i class="fa fa-home"></i> My Orders</a></li>
                            <li><a href="https://qr2.gsm2go.com/v6/profile"><i class="fa fa-user"></i> My Profile</a></li>
                            <li><a href="https://qr2.gsm2go.com/v6/logout"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
                        </ul>
                        <?php } else{ ?>
                                                        ...
                                                        <div class="col-12 pl-4">
                                                            ...
                                                            <div class="form-check mb-2">
                                                                ...
                                                                <label class="form-check-label">
                                                                    I understand that in order to use an eSIM, I need an eSIM compatible phone (please see <a href="https://qr2.gsm2go.com/v6/esim-phones.php" target="blank">list</a> here).
                                                                </label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input agree agree<?php echo $plan_row['id']; ?>" type="checkbox" value="<?php echo $plan_row['id']; ?>">
                                                                <label class="form-check-label">
                                                                    I am ok with the <font color="blue">gsm</font><font color="green">2go</font> eSIM <a href="https://qr2.gsm2go.com/v6/tnc.php" target="blank">Term & Conditions</a> and Privacy Policy
                                                                </label>
                                                            </div>
                                                        </div>
