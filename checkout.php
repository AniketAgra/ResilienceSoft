...
function getAnAcceptPaymentPage($orderId,$total_charge,$customerProfileId)
{
    ...
    $setting5->setSettingValue(
        "{\"url\": \"".$base_url."/iframecommunicator.html\",}"
    );
...
if(isset($total_charge)) {
    ...
    $respData = getAnAcceptPaymentPage($orderId,$total_charge,$customerProfileId);
...
h5.font-weight-700.px-4.px-md-5.px-lg-4.px-xl-4.pt-3.mb-3 {
    display: flex;
    justify-content: space-between;
}
.heading-rtl{
...
.heading-rtl .title-divider-round{
    margin: 10px 20px 0;
}
.testCardNumberInput {
    text-align: right !important;
                ...
                <div class="col-lg-8">
                    ...
                    <div class="pb-3">
                        <div class="bg-white rounded-xl shadow-lg px-4 py-5 p-md-4">
                            <h5 class="font-weight-700 section-title-4 text-left pb-2 mb-2 bg-img heading-rtl">
                                Payment Details
