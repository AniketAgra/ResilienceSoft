...
<head>
    ...
    <title>gsm2go eSIM | Thank you</title>
...
<!-- Content -->
<div class="main-content py-0 align-middle">
    ...
    <div class="section py-5 mt-4 mb-5">
        <div class="container">
            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-md-12">
                    <div class="pl-xl-5 text-center">
                        <span style="border:3px solid green;border-radius:50%;display:inline-block;color:green" class="p-3">
                            <i class="fa fa-4x fa-check" aria-hidden="true"></i>
                        </span>
                        
                        <h1 class="font-weight-900 mt-3 mb-4">Thank You!</h1> 

                        <h5 style="font-family: Calibri, sans-serif;font-size:11pt;" >We like to respond quickly, more often than not – within a few hours.<br>
Please expect our reply very soon.</h5>
