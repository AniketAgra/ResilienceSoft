...
<head>
    ...
    <title>gsm2go eSIM | Global Dialer Plans</title>
    ...
    <style>
    body{ font-family:calibri;font-size:1rem; }
...
<?php
$select = mysqli_query($con, "Select * from pages where id='7'");
$row = mysqli_fetch_assoc($select);
?>
<!-- Page title -->
<div class="d-flex flex-column w-100">
    <div class="page-title d-flex align-items-center bg-image" data-img-src="assets/images/upload/top_tsq.jpg">
