...
//$update = mysqli_query($con, "update users set fname='$fname', lname='$lname', mobile='$mobile', password='$pass', status='$status' where id='".$_GET['id']."' AND role='U'");
	$update = mysqli_query($con, "update users set fname='$fname', lname='$lname', mobile='$mobile', status='$status' where id='".$_GET['id']."' AND role='U'");
	if($update)
	{
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group" style="display:none;">
												...
												<input type="password" class="form-control" name="pass" value="<?php echo $row['password']; ?>" placeholder="Enter Password" required="required">
											</div>
										</div>
									</div>
									<div class="row">
