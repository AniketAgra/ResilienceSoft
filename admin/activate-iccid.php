							...
							<div class="card-body">
								<form method="post" id="activationForm" action="activate_esim.php">
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form__div">
												<input type="email" name="to_email" id="to_email" value="cs@gsm2go.com" class="form__input" placeholder=" " required>
												...
												<div class="col-md-8 mg-t-5 mg-md-t-0">
													<select name="distributor" id="distributor" class="form-control d-inline">
    												    ...
    												    while($row = mysqli_fetch_assoc($select)){
    												        echo '<option data-id="'.$row['id'].'" value="'.$row['distributor_moniker'].'">'.$row['distributor'].'</option>';
    												    }
    												    ?>
    												</select>
												</div>
										...
										<div class="col-md-4">
											<div class="form__div">
												<input type="text" name="limit" id="limit" class="form__input" value="500" placeholder=" ">
												<label for="limit" class="form__label">Limit<span class="text-danger">*</span></label>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form__div">
												<input type="text" name="warning" id="warning" class="form__input" value="150" placeholder=" ">
