					...
					<div class="col-lg-12 col-md-12">
						<div class="card custom-card">
							<div class="card-body p-0">
								<?php
								$result = mysqli_query($con, "select *,CASE WHEN status='A' THEN 'Active' ELSE 'Deactive' END AS status from users where role='U' ORDER BY id DESC");			
								$i = 1;
								$rows =  '[';
...
<span style="float:right;" class="row">
    ...
    <div class="col-md-3">
        <div class="text-right">
            <a href="add-user.php" class="btn btn-primary btn-rounded py-1"><i class="fa fa-plus"></i></a>
...
$(document).ready(function () {
    ...
    $treeGrid.jqxGrid(
    {
        ...
        columns: [
            ...
            { text: 'First Name', dataField: 'fname', width:200},
            { text: 'Last Name', dataField: 'lname', width:200},
            { text: 'Mobile', dataField: 'mobile', width:150},
            { text: 'email', dataField: 'email', width:150},
            { text: 'Last Login', dataField: 'last_login', width:150},
            { text: 'Status', datafield: 'status', filtertype: 'checkedlist', width: 120, cellsalign: 'center' },
            { text: 'Date', datafield: 'date', cellsformat:'dd-MMM-yy HH:mm:ss (ddd)', filtertype: 'date', width: 210, cellsalign: 'center' },
            { text: 'Action', datafield: 'action',filterable:false, width: 100,
                cellsrenderer: function (row) {
                   
                    return '<div class="text-center mt-2"><a href="edit-user.php?id='+ $treeGrid.jqxGrid('getCellValue', row, 'id') +'"><i class="fa fa-pen mr-2" aria-hidden="true" title="Edit"></i></a> <a href="delete-user.php?id='+ $treeGrid.jqxGrid('getCellValue', row, 'id') +'"><i class="fa fa-trash text-danger" aria-hidden="true" title="Delete"></i></a></div>';
                }
            },
        ]
    });
