...
if(isset($_POST['submit']))
{
    ...
    $insert = mysqli_query($con, "insert into companies (companyName,status) values ('$company','$status')");
    if($insert) 
    {
        echo "<script>alert('Comapny Added Successfully')</script>";
    }
}
?>
<!-- Loader -->
									...
									<table class="table" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-10p">Distributor Moniker</th>
												<th class="wd-10p">Customer Group</th>
												<th class="wd-10p">Customer Group Moniker</th>
										...
										<tbody>
											<?php
											$i = 1;
											$select = mysqli_query($con, "select * from t_companies");
											...
											<tr>
												...
												<td><?php echo $row['distributor_moniker']; ?></td>
												<td><?php echo $row['customer_group']; ?></td>
												<td><?php echo $row['customer_group_moniker']; ?></td>
