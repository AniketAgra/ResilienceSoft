                                ...
                                <div id="error-msg" class="text-center col-md-12"><?php if(isset($_SESSION['userid']) && !empty($_SESSION['userid'])){ echo '<div class="text-success mb-0 mx-2">Password Sent Your Email Address</div>'; } ?></div>
                                    <div class="">
                                        <div class="user-box">
                                            ...
                                            <!--</div>-->
                                            <input type="text"  required=""  class="form-control form-control-lg" id="username" placeholder="" <?php if($loginEmail != '') { echo "readonly"; } ?> value="<?php if(isset($_SESSION['q'])) { echo $_SESSION['q']; } else if($loginEmail != '') { echo $loginEmail; } ?>" tabindex="1" autocomplete="off">
