...
{ 
    ...
    if (mysqli_num_rows($check_email)===1) 
    {
        ...
        if($insertcode)
        {
            ...
            $url = constant("SITEURL")."update-password?id=".$id;

            $message = '<table align="center" cellspacing="0" cellpadding="0" style="width: 540px; margin: 0px; font-family: Helvetica; letter-spacing: normal; text-indent: 0px; text-transform: none; word-spacing: 0px; text-decoration: none;">
                    <tbody>
                        <tr>
                            <td>
                                        ...
                                        <tr>
                                            <td style="padding-left: 0px; padding-top: 9px; padding-bottom: 9px;text-align:center">
                                                <div style="margin: 0px; font-size: 18px; font-family: arial, sans-serif;">
                                                    <form target="_blank" method="post" action="'.constant("SITEURL").'update-password">
