...
$(document).ready(function () {
    ...
    var source =
    {
        ...
        datafields: [
            ...
            { name: 'date', type: "date" },
            { name: 'activationFrom', type: "string" },
			{ name: 'activationName', type: "string" },
			{ name: 'activationByName', type: "string" },
        ],
        id: 'orderId'
    };
        ...
        columns: [
            ...
            { text: '#', dataField: 'id', width:60,cellsalign: 'center',align: 'center',
                cellsrenderer: function (row) {
                    ...
                    return '<div class="text-center mt-2"><a href="view-mail.php?orderId='+ $treeGrid.jqxGrid('getCellValue', row, 'id') +'">'+ $treeGrid.jqxGrid('getCellValue', row, 'id') +'</a></div>';
                }
            },
            { text: 'Date', datafield: 'date', cellsformat:'dd-MMM-yy (ddd)', filtertype: 'date', width: 150, cellsalign: 'left' },
            { text: 'Activation From', dataField: 'activationFrom', filtertype: 'checkedlist', width:150},
            { text: 'Activation By', dataField: 'activationByName', width:150},
            { text: 'Activation Name', dataField: 'activationName', width:150},
