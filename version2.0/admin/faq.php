		...
		<div class="modal-content modal-content-demo">
			...
			<div class="modal-body">
				<form id="form-search">
					...
					<div class="form-group">
						<button type="button" class="btn btn-block btn-primary" id="insert">Add FAQ</button>
					</div>
				</form>
			</div>
		</div>
...
$('#insert').click(function() {
   ...
   $.ajax({
      ...
      type: "POST",
      data: { title:title,status:status,desc:desc },
...
$('#update').click(function() {
   ...
   $.ajax({
      ...
      type: "POST",
      data: { id:id,title:title,status:status,desc:desc },
      success: function(data)
      {
