...
<head>
    <meta charset="utf-8">
    <meta content="width=device-width, iadmin_nitial-scale=1, shrink-to-fit=no" name="viewport">
                ...
                <div class="page-header my-1">
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">MSISDN</li>
                        </ol>
                    </div>
                </div>
                <!-- End Page Header -->
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card custom-card">
                            <div class="card-body p-0">
                                <?php
                                $result = mysqli_query($con, "select * from MSISDN");          
                                $i = 1;
                                $rows =  '[';
...
<span style="float:right;" class="row">
    <div class="col-md-6">
        <div class="totalCnts text-center">
            Total MSISDN : <span class="boldLt" id="filRecTot"><?php echo 0; ?></span>
        </div>
    </div>
    <div class="col-md-5">
...
$(document).ready(function () {
    ...
    $treeGrid.jqxGrid(
    {
        ...
        columns: [
            ...
            { text: 'MSISDN', dataField: 'MSISDNs', width:200},
