...
const columnDefs = [
    ...
    headerName: 'Athlete',
    children: [
    { field: 'athlete',suppressMenu: true,rowDrag:true,tooltipField: 'athlete',
    chartDataType: 'category', rowDragManaged:false,headerCheckboxSelection: true,
      checkboxSelection: true,
  suppressMoveWhenRowDragging: true,  minWidth: 200,checkboxSelection: checkboxSelection,
    headerCheckboxSelection: headerCheckboxSelection,  filter: 'agTextColumnFilter',suppressKeyboardEvent: (params) => {
      return suppressEnter(params) || suppressNavigation(params);
    },  },
    { field: 'age',sortable: false,
    headerComponentParams: { menuIcon: 'fa-external-link-alt' },hide:true,chartDataType: 'series' ,suppressMenu: false,minWidth: 150, filter: 'agTextColumnFilter',suppressHeaderKeyboardEvent: (params) => {
      var key = params.event.key;

      return key === 'ArrowLeft' || key === 'ArrowRight' || key === 'Enter';
    },  },
      { field: 'country',suppressHeaderKeyboardEvent: (params) => {
      var key = params.event.key;

      return key === 'ArrowLeft' || key === 'ArrowRight' || key === 'Enter';
    },suppressMenu: true,chartDataType: 'series' ,hide:true, suppressMenu: false,minWidth: 200, filter: 'agTextColumnFilter' },
   ],},
   {
    headerName: 'Competition',
    children: [{ field: 'year',suppressHeaderKeyboardEvent: (params) => {
      var key = params.event.key;

      return key === 'ArrowLeft' || key === 'ArrowRight' || key === 'Enter';
    },sortable: false ,tooltipField: 'year',chartDataType: 'series' ,suppressMenu: false,minWidth: 200, filter: 'agNumberColumnFilter', }, 
    { field: 'date',suppressHeaderKeyboardEvent: (params) => {
      var key = params.event.key;

      return key === 'ArrowLeft' || key === 'ArrowRight' || key === 'Enter';
    },suppressMenu: true, hide:true,chartDataType: 'series' ,
  ...
  { field: 'sport',suppressHeaderKeyboardEvent: (params) => {
      var key = params.event.key;
       ...
       },
  {
    headerName: 'Medals',
    children: [
      { field: 'gold',suppressHeaderKeyboardEvent: (params) => {
      var key = params.event.key;

      return key === 'ArrowLeft' || key === 'ArrowRight' || key === 'Enter';
    }, headerComponentParams: { menuIcon: 'fa-cog' },hide:true,chartDataType: 'series' ,enableRowGroup: false,suppressMenu: false, minWidth: 150,filter: 'agTextColumnFilter',
      menuTabs: ['generalMenuTab', 'gibberishMenuTab'], },
      { field: 'silver',suppressHeaderKeyboardEvent: (params) => {
      var key = params.event.key;

      return key === 'ArrowLeft' || key === 'ArrowRight' || key === 'Enter';
    },sortable: false ,chartDataType: 'series' ,hide:true,enableRowGroup: false,suppressMenu: false,minWidth: 150, filter: 'agTextColumnFilter',
      menuTabs: ['generalMenuTab', 'gibberishMenuTab'], },
      { field: 'bronze',suppressHeaderKeyboardEvent: (params) => {
      var key = params.event.key;

      return key === 'ArrowLeft' || key === 'ArrowRight' || key === 'Enter';
    },suppressMenu: true,chartDataType: 'series' ,hide:true,enableRowGroup: false,suppressMenu: false, minWidth: 150,filter: 'agTextColumnFilter',
      menuTabs: ['generalMenuTab', 'gibberishMenuTab'], },
      { field: 'total',suppressHeaderKeyboardEvent: (params) => {
      var key = params.event.key;
 ...
 { field: 'Action',suppressSizeToFit: true,filter: false,
