            ...
            <tbody>
                ...
                <tr>
                    <td style="background: #fff;padding: 10px 10px;color: #000;text-align: left">
                        <img src="https://gsm2go.com/qr/'.$order_row['ICCID'].'.png" style="max-width:250px">
                    </td>
                </tr>
                <tr>
                    ...
                    <div class="pb-3 mb-3">
                        <div class="bg-white rounded-xl shadow-sm px-4 py-5 py-md-3">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-xl-4 mb-4 mb-md-0 text-right">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body py-2">
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="email" id="id" value="<?php echo $_POST['typeId']; ?>">
