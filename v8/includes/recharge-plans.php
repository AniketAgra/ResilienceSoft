                                                ...
                                                <div class="row">
                                                    <form method="post">
                                                        ...
                                                        <div class="col-12 col-md-6 mx-auto">
                                                            ...
                                                            <?php } else{ ?>
                                                            <button type="submit" formaction="https://esim.gsm2go.com/login" id="<?php echo $plan_row['id']; ?>" class="btn btn-block buybutton btn-round btn-md btn-primary mx-2 mt-4 mx-lg-3 mb-4 buy-now<?php echo $plan_row['id']; ?>" disabled>Proceed</button>
                                                            <?php } ?>
                                                        </div>
                                                    </form>
                                                </div>
