...
else
{
	...
	if(mysqli_num_rows($check)===1)
	{
		...
		$url = "https://esim.gsm2go.com/verification?userId=".$id.'&ecode='.$emailcode;
		$url1 = "https://esim.gsm2go.com/verification?userId=".$id;
		$message = '<table cellspacing="0" cellpadding="0" style="width: 540px; font-family: Helvetica; letter-spacing: normal; text-indent: 0px; text-transform: none; word-spacing: 0px; text-decoration: none;">
				    <tbody>
				        <tr>
				            <td>
				                                ...
				                                <table cellspacing="0" cellpadding="0">
				                                    <tbody>
				                                        <tr>
				                                            <td width="250">
				                                                <img src="'.$logourl.'"
				                                                    style="border: 0px; margin: 0px; height: 35px;" />
				                                            </td>
