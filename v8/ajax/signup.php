...
else
{
	...
	if(mysqli_num_rows($check)===0)
	{
		...
		if($insert)
		{
			...
			$logourl = "https://esim.gsm2go.com/assets/logo.png";
			$url = "https://esim.gsm2go.com/verification?userId=".$userId.'&ecode='.$emailcode;
			$url1 = "https://esim.gsm2go.com/verification";
				                            ...
				                            <td style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: rgb(234, 234, 234); padding: 10px 0px 0px 0px;">
				                                <table cellspacing="0" cellpadding="0">
				                                    <tbody>
				                                        <tr>
				                                            <td width="250">
				                                                <img src="'.$logourl.'" style="border: 0px; margin: 0px; height: 35px;" />
				                                            </td>
