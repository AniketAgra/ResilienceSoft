                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card custom-card">
                            <div class="card-body p-0">
                                <?php
                                $result = mysqli_query($con, "select * from ICCID ORDER BY status DESC");          
                                $i = 1;
                                $rows =  '[';
    ...
    <div class="col-md-3">
        <div class="columChooser">
            <select multiple="multiple" id="columnList" class="search-box">
                ...
                <option value="Camel_Profile_ID">Camel_Profile_ID</option>
                <option value="Matching_Code">Matching_Code</option>
            </select>
        </div>
    </div>
</span>
