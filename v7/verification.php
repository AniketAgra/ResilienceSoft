                        ...
                        <div class="px-xl-4">
                            <div class="bg-white rounded-ultra shadow-lg px-4 py-3 my-5">
                                ...
                                <form>
                                    ...
                                    <button type="button" id="checkout" class="btn btn-lg btn-round btn-indigo btn-block mb-0 text-capitalize checkout" <?php if((!isset($everify)) OR (!isset($mverify)) OR (!isset($eaverify)) OR (!isset($maverify)) ){ ?>disabled="disabled" <?php } ?> ><i class="fas fa-sign-in-alt"></i>Checkout</button>
