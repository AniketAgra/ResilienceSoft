                                                ...
                                                <div class="row">
                                                    <form method="post">
                                                        ...
                                                        <div class="col-12 col-md-6 mx-auto">
                                                            ...
                                                            <?php } else{ ?>
                                                            <button type="submit" formaction="<?php echo GLOBALURL; ?>/login" id="<?php echo $plan_row['id']; ?>" class="btn btn-block buybutton btn-round btn-md btn-primary mx-2 mt-4 mx-lg-3 mb-4 buy-now<?php echo $plan_row['id']; ?>" disabled>Proceed</button>
                                                            <?php } ?>
                                                        </div>
                                                    </form>
                                                </div>
