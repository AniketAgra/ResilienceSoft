    ...
    <div class="bg-white rounded-xl shadow-lg">
            ...
            <form name="payment_form">
                <!-- <div class="bank-card">
                 ...
                 <div class="input-img">
                    ...
                    <label for="html"><img src="1596627.png" alt="" class="img-fluid"></label><br>
                </div>
                <div class="input-img">
        ...
        <?php
            if (isset($_POST['submit'])) { // check if the form has been submitted
                $_SESSION['my_variable'] = 'my_value'; // set the session variable
            }
            ?>
        <div class="card" style="border:none; display:none;">
            <div class="row">
                <div class="col-12">
                    ...
                    <a href="<?php echo $plan['id'];  ?>"<?php echo $plan['plan_name']."-".$plan['zone_name'];  ?> class="btn btn-primary back-btn">Back</a>
                    </div>
...
const tokenizationSpecification = {
 ...
 parameters: {
  'gateway': 'example',
  'gatewayMerchantId': 'BCR2DN4TXLG5X7AL'
 }
};
...
function getGooglePaymentDataRequest() {
 ...
 paymentDataRequest.merchantInfo = {
  ...
  merchantId: 'BCR2DN4TXLG5X7AL',
  merchantName: 'gsm2go inc'
 };
